...
<!-- Marketplace-friendly diagram (PNG). Place the screenshot at docs/images/agent-library-flow.png -->
![Agent Library → Agent Hub → GitHub Copilot](/docs/images/agent-library-flow.png)
